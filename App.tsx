      ...
      <div className="flex-1 flex flex-col lg:flex-row md:ml-64 transition-all duration-300">
        <main className="flex-1 p-4 md:p-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-8">
            ...
            <div className="h-full"><SavingsGoals transactions={transactions} /></div>
          </div>
        ...
        <aside className="lg:sticky lg:top-0 h-auto lg:h-screen transition-all"><AIBuddy transactions={transactions} /></aside>
      </div>
    </div>
  );
};
